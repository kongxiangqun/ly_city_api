    ...
    <div class="cart-info">
      ...
      <div class="discount">
          ...
          <div class="credit-box">
            ...
            <p class="discount-num2" v-else><span>总积分：{{credit}}，
              <el-input-number v-model="num" @change="handleChange" :min="0" :max="max_credit()" label="描述文字"></el-input-number>，已抵扣 ￥{{num / credit_to_money}}，本次花费{{num}}积分</span></p>
          </div>
...
<script>
  ...
  export default {
    ...
    // },
        ...
        // coupon_id 这个参数是点击获取样式的 点击的如果和传过来的相等
