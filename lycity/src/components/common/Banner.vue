...
<script>
    ...
    export default {
      ...
      data(){
          return {
            ...
            //   {id:3,img_src:require('@/assets/banner/banner3.png'),link:'http://www.baidu.com'},
              ...
              //方式2：直接使用static目录
              // {id:1,img_src:'../../../static/img/banner1.png',link:'http://www.baidu.com'},
              // {id:2,img_src:'../../../static/img/banner2.png',link:'http://www.baidu.com'},
              // {id:3,img_src:'../../../static/img/banner3.png',link:'http://www.baidu.com'},
      ...
      methods:{
        get_banner_data(){
          this.$axios.get(`${this.$settings.Host}/home/banner`) //""就出来了url
          .then((res)=>{
            console.log(res);
